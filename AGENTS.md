...
When Firstmate accepts a clarification or supersession after a run starts without invalidating it, send it to that worker and require the generated brief's next-gate recorded-intent reconciliation before validation proceeds.
