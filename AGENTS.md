...
Account for every candidate with the catalog evidence, provider relationship, applicable capacity and authentication facts, remaining uncertainty, fit and reasoning class, and the rank, runway, and later pace or reserve evidence used in selection; never omit a candidate, guess, fall back silently, or call the result capacity-informed without them.
